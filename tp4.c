...
// Fonction récursive pour insérer un élément dans l'ABR
...
T_Arbre insererElement(T_Arbre abr, int element) {
    ...
    return insererElementRec(abr, element);
}
...
// Fonction pour rechercher un élément dans l'ABR
T_Sommet* rechercherElement(T_Arbre abr, int element) {
    return rechercherElementRec(abr, element);
}
...
// Fonction pour afficher les sommets de l'ABR
void afficherSommets(T_Arbre abr) {
    afficherSommetsRec(abr);
    printf("\n");
}
